...
# This script generates FIGURE 14D of the DataPaper published in Earth Science System Data:
...
#
# Output :
#   - PostScript file: section_CC-time.ps
#
# Usage :
#   $ ./section_CC-time.zsh
#
...
echo "37.3 39" |read VL1 VL2
echo "38.3 36.8" |read VL3 VL4
...
echo "0 -1 C" | gmt pstext -R0/$dist/-$vprof/5 -JX$vx/$valt -F+f50p,Helvetica-Bold,black+jLT -Dj-1c/-4c -O -K -N >> $OUT
echo "$dist -1 C'" | gmt pstext -R0/$dist/-$vprof/5 -JX$vx/$valt -F+f50p,Helvetica-Bold,black+jRT -Dj-1c/-4c -O -N >> $OUT
